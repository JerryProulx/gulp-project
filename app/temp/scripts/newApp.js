...
__WEBPACK_IMPORTED_MODULE_0_jquery___default()(document).ready(function(){
  ...
  let mobileMenu = new __WEBPACK_IMPORTED_MODULE_1__modules_MobileMenu__["a" /* default */]();

  let revealFeatures = new __WEBPACK_IMPORTED_MODULE_2__modules_RevealOnScroll__["a" /* default */]('.feature-item', '85%');

  let revealTestimonial = new __WEBPACK_IMPORTED_MODULE_2__modules_RevealOnScroll__["a" /* default */]('.testimonial', '50%');

  let siteHeader = new __WEBPACK_IMPORTED_MODULE_3__modules_StickyHeader__["a" /* default */]();
...
class RevealOnScroll {
  constructor(itemClass, offset){
    this.itemsToReveal = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(itemClass);
    this.offset = offset;
    this.hideInitially();
  ...
  createWayPoints(){
    ...
    this.itemsToReveal.each(function(index, el){
      ...
      new Waypoint({
        element: item,
        handler: () => {
          __WEBPACK_IMPORTED_MODULE_0_jquery___default()(item).addClass('reveal-item--visible')
        },
        offset
      });
    });
  ...
  createWaySectionsWayPoints(){
    this.pageSections.each((index, el) => {
      ...
      new Waypoint({
        ...
        handler: (direction) => {
          if(direction === 'down'){
            var matchingID = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(el).attr('data-matching-link');
            this.headerLinks.removeClass('link-active');
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()(matchingID).addClass('link-active');
          }
        },
        offset: '20%'
      });
...
class ModalOverlay {
  constructor(){
    ...
    this.modalCloseButton = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.modal__close-button');
    this.getInTouchButton = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.open-modal');
    this.modalText = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.modal__text')
    this.events();
  }
...
/* harmony default export */ __webpack_exports__["a"] = (ModalOverlay);
